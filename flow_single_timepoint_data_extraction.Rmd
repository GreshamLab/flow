...
```{r Ploidy}
#make sure pData is associated with gated sample
pData(flowData.nondebris) <- pData(flowData)

p = ggcyto(flowData.nondebris, aes(x = `FSC.A`)) 
...
if(pi == TRUE) {
  p = ggcyto(flowData.nondebris, aes(x = `FL2.A`)) 
