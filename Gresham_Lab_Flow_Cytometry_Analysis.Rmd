...
|:---|:---|:---|:---|
|A01.fcs|Ploidy_1.5ploid|Dye_acridineOrange|...|
|A02|Ploidy_2.5ploid|Dye_acridineOrange|...|
|A03.fcs|Ploidy_1.5ploid|Dye_sytoselect|...|

Why `Variable1` etc? It's generalizable to more than just one 
exerperiment, yet the key value relationship is preserved with the
`key_value` format.
...
dataDirectoryz <- c("exampleDataset1")
...
Now you have `oneBigFlowSet`. Great.
