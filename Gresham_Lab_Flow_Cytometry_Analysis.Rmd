...
RStudio seems to have fucked up how they packaged `httpuv`, and didn't 
test a non-gui install, like they should. I'm not alone in this 
problem, 
...
unless you manually install it.
So `flowWorkspace` won't load right.
